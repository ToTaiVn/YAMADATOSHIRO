...
local Window = OrionLib:MakeWindow({Name = "Simple Hub [Beta Version]", HidePremium = false, SaveConfig = true, IntroEnabled = true, IntroText = "Simple Hub Beta Version", IntroIcon = "rbxassetid://15323602400", Icon = "rbxassetid://15323602400", ConfigFolder = "hehehehSimpleHub"})

OrionLib:MakeNotification({
	Name = "Chuc Cac Ban Choi Game Vui Ve",
	Content = "Chuc Cac Ban Mot Ngay Vui!!!",
	Image = "rbxassetid://15323602400",
	Time = 5
})
...
function EquipWeaponMelee()
	pcall(function()
		for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
			if _G.Select_Weapon == "Melee" and v:IsA('Tool') then
				local ToolHumanoid = game.Players.LocalPlayer.Backpack:FindFirstChild(v.Name) 
				game.Players.LocalPlayer.Character.Humanoid:EquipTool(ToolHumanoid) 
			end
		end
...
warn("Loaded Complete!!")


OrionLib:MakeNotification({
	Name = "Loaded Complete!! Wish You Got A Good Time!",
	Content = "This is Beta Ver Maybe Has Bug! ",
	Image = "rbxassetid://15323602400",
	Time = 5
})
